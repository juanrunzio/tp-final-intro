...
def seed_database():
    with app.app_context():
        ...
        evento1 = Evento(nombre="Lanzamiento de martillo", fecha=datetime(2023, 8, 2), lugar="Stade de France")
        evento2 = Evento(nombre="Decatlón", fecha=datetime(2023, 8, 2), lugar="Stade de France")
